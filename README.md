# NFT Marketplace (Back-end) - Hardhat:
...
This is a repo showing an NFT Marketplace from scratch!
...
Head over to [Chainlink faucets](https://faucets.chain.link/) and get some tesnet ETH. You should see the ETH show up in your metamask.
